          ...
          <div id="authors_flex">
            <Card border="dark">
              ...
              <Card.Body>
                ...
                <Button href="/RPP2/authors/metliskij" variant="outline-dark">
                  Об авторе
                </Button>
              </Card.Body>
            </Card>
            ...
            <Card border="dark">
              ...
              <Card.Body>
                ...
                <Button href="/RPP2/authors/hilevich" variant="outline-dark">
                  Об авторе
                </Button>
              </Card.Body>
            </Card>
            ...
            <Card border="dark" className="">
              ...
              <Card.Body>
                ...
                <Button href="/RPP2/authors/brovka" variant="outline-dark">
                  Об авторе
                </Button>
              </Card.Body>
            </Card>
            ...
            <Card border="dark">
              ...
              <Card.Body>
                ...
                <Button href="/RPP2/authors/borodulin" variant="outline-dark">
                  Об авторе
                </Button>
              </Card.Body>
            </Card>
            ...
            <Card border="dark">
              ...
              <Card.Body>
                ...
                <Button href="/RPP2/authors/globus" variant="outline-dark">
                  Об авторе
                </Button>
              </Card.Body>
            </Card>
